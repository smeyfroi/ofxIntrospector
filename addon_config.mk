...
meta:
	ADDON_NAME = ofxIntrospector
	ADDON_DESCRIPTION = Temporary layer to introspect an app
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon" "introspector" "debug"
	ADDON_URL = http://github.com/smeyfroi/ofxIntrospector
